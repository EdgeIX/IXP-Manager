...
?>
#
# Bird v2 (2025) Route Server configuration generated by IXP Manager
#
...
#
# BFD — passive on all interfaces.
#
# We never initiate BFD; if a peer enables it on their side and sends BFD
# control packets, BIRD responds and the session establishes. BFD failure
# brings BGP down within ~900ms instead of waiting for the BGP hold timer.
#
# Peers who don't run BFD are unaffected.
#
protocol bfd {
    interface "*" {
        passive on;
