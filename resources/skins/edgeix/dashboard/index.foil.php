<?php
    /**
     * EdgIX skin: Customer dashboard — adds Pseudowires tab.
     *
     * This is a skin override of the upstream dashboard/index.foil.php.
     * The only addition is the "Pseudowires" tab for customers who have
     * active or historical pseudowire circuits (as requester or target).
     */
