                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?= route( 'statistics@p2p-per-vlan', [
                                        ...
                                        'category' => $t->category,
                                        'period' => $pvalue] ) ?>">
                                    <?php // EdgeIX skin: swap boxLegacy → boxUplot. Our Akvorado backend has no
                                          // server-side PNG (returns 1x1 placeholder); uPlot renders client-side from
                                          // $graph->data() which multiP2pTraffic() populates. ?>
