<?php
     ...
     *
     * Full-width layout: compact connection details on top, graphs below in a grid.
     */
...
<div class="col-sm-12 mb-4">
    ...
    <?php else: ?>
        <?php if( $t->vi->typePeering() ): ?>
            <p class="text-muted">No VLAN interfaces defined.</p>
        <?php endif; ?>
    <?php endif; ?>

    <?php // ── Graphs (full-width grid) ── ?>
    <?php if( $countPis > 0 ): ?>
        <div class="row mt-3">
