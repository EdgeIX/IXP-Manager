<?php
    /**
     * EdgIX skin: Admin customer overview — adds Pseudowires tab.
     *
     * Copy of upstream customer/overview.foil.php with the addition of
     * a "Pseudowires" tab showing circuits where this customer is
     * requester or target.
     */
    ...
    <div class="card mt-4">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <?php if( $hasPseudowires ): ?>
                    <li role="pseudowires" class="nav-item">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <?php if( $hasPseudowires ): ?>
                    <div id="pseudowires" class="tab-pane fade <?php if( $t->tab === 'pseudowires' ): ?> active show <?php endif; ?>">
