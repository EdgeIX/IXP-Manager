<?php
/**
 * EdgIX skin: Customer (custuser) top navbar.
 *
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <?php
                ...
                $showDocstore = !config( 'ixp_fe.frontend.disabled.docstore' ) && \IXP\Models\DocstoreDirectory::getHierarchyForUserClass( \IXP\Models\User::AUTH_CUSTUSER );
                $showMyDocs   = !config( 'ixp_fe.frontend.disabled.docstore_customer' ) && \IXP\Models\DocstoreCustomerFile::getListingForAllDirectories( Auth::getUser()->custid, \IXP\Models\User::AUTH_CUSTUSER );
            ?>
